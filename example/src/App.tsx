...
function App() {
  const { targetHeaderFraction, effectiveHeaderHeight, mapHeight, refHeader, refMapContainer } =
    useMapHeader();
      ...
      >
        <div>
          ...
          <h2 className={styles.subtitle}>
            A React component to alternate map + route profile, similar to Trailforks,
            Outdooractive, Komoot, or Bikemap.
          </h2>
        </div>
      </header>
